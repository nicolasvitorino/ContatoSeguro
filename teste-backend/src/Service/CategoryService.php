...
class CategoryService
{
    ...
    public function filterProductsActives()
    {
        $activeFilter = 1;
        $sql = "SELECT * FROM produtos WHERE ativo = $ActiveFilter";
    }

    public function filterProductsInactives()
    {
        $activeFilter = 0;
        $sql = "SELECT * FROM produtos WHERE ativo = $InactiveFilter";
    }

    public function filterProductsByCategory($categoria)
    {
        $sql = "SELECT * FROM produtos WHERE categoria = '$categoria'";

    }

    public function orderProductsByRegistrationDate()
    {
        $ordenacao = 'data_cadastro';
        $sql = "SELECT * FROM produtos ORDER BY $ordenacao";
